...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=01faw9p23up7bwwe" />
      <FrameContainer
      ...
      >
        <FrameImage
          ...
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://open.spotify.com/">link</FrameButton>
<FrameButton action="post_redirect" target="https://www.privy.io/">post</FrameButton>
