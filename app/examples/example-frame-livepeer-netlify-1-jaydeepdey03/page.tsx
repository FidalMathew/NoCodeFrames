...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=a70bcrbm1pgzqmnu" />
      <FrameContainer
      ...
      >
        <FrameImage
          ...
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://videocaster.netlify.app/viewer?frame=https://no-code-frames.vercel.app/examples/example-frame-livepeer-netlify-1-jaydeepdey03">View on VideoCaster</FrameButton>
