...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=93a6xa621h6svz9c" />
      <FrameContainer
      ...
      >
        <FrameImage
          src="https://gateway.pinata.cloud/ipfs/bafybeig2dlvcmddt6dbwhjshgpvpac4sbq7mg7bkpvgohdvdeixidjvw7q"
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://videocaster.vercel.app/viewer?frame=https://no-code-frames.vercel.app/examples/local-fid-1-jaydeepdey03">View on VideoCaster</FrameButton>
