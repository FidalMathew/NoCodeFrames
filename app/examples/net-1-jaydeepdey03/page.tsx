...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=b6f3s2mdsn7zaqrl" />
      <FrameContainer
      ...
      >
        <FrameImage
          ...
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://videocaster.vercel.app/viewer?frame=https://no-code-frames.vercel.app/examples/net-1-jaydeepdey03">View on VideoCaster</FrameButton>
