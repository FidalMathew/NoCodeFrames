...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=be130tiszh5qs9so" />
      <FrameContainer
      ...
      >
        <FrameImage
          ...
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://videocaster.netlify.app/viewer?frame=https://no-code-frames.vercel.app/examples/example-frame-livepeer-netlify-2-jaydeepdey03">View on VideoCaster</FrameButton>
<FrameButton action="link" target="https://youtu.be/VeHvXl3I5Zk">Youtube Video</FrameButton>
