...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=32b7kywcml9psmfl" />
      <FrameContainer
      ...
      >
        <FrameImage
          src="https://gateway.pinata.cloud/ipfs/bafkreifmmlb2jygwpjoaqurqcrq2tnfmkg3lbjkj3azjrlslmdhccvm43y"
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://videocaster.vercel.app/viewer?frame=https://no-code-frames.vercel.app/examples/whatsapp-1-jaydeepdey03">View on VideoCaster</FrameButton>
