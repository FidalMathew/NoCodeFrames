...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=3ac2lu5yssora97y" />
      <FrameContainer
      ...
      >
        <FrameImage
          src="https://gateway.pinata.cloud/ipfs/bafkreihnshgfyn6dd4pexjski7vttgonknaiaq5lshb55atrw4phggabsu"
          aspectRatio="1:1"
        ></FrameImage>
