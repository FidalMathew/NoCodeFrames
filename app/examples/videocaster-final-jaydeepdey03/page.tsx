...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=24c07wkvuz1f7arp" />
      <FrameContainer
      ...
      >
        <FrameImage
          ...
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://videocaster.netlify.app/viewer?frame=https://no-code-frames.vercel.app/examples/videocaster-final-jaydeepdey03">View on VideoCaster</FrameButton>
