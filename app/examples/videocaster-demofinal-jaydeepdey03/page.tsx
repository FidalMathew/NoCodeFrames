...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=d766ojhvwsvvj1to" />
      <FrameContainer
      ...
      >
        <FrameImage
          src="https://gateway.pinata.cloud/ipfs/bafybeiadfkxyprqkilirew6bpad27mpmwrqblvpcjzd7cjrrslkyprz4xm"
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://videocaster.netlify.app/viewer?frame=https://no-code-frames.vercel.app/examples/videocaster-demofinal-jaydeepdey03">View on VideoCaster</FrameButton>
<FrameButton action="link" target="https://www.youtube.com/watch?v=VeHvXl3I5Zk&ab_channel=JaydeepDey">View demo</FrameButton>
