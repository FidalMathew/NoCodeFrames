...
export default async function Home({ searchParams }: NextServerPageProps) {
  ...
  return (
    <div>
      ...
      <meta name="fc:frame:video" content="https://lvpr.tv?v=abd4nkinzbtoo0l9" />
      <FrameContainer
      ...
      >
        <FrameImage
          src="https://fastly.picsum.photos/id/151/1146/600.jpg?hmac=YoTyEZ-JsHjDNUliKzC3vP5HCGjixaWPH1ll-nU0HTo"
          aspectRatio="1:1"
        ></FrameImage>
        <FrameButton action="link" target="https://www.instagram.com/">follow us on instagram</FrameButton>
